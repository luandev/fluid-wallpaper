...
export function defaultWindStations(): WindStation[] {
  return [
    {
      id: "wind-1",
      name: "Station 1",
...
export function defaultValueBindings(): ValueBinding[] {
  return [
    {
      id: "bind-1",
...
export const defaultConfig: FluidConfig = {
  ...
  valueEmitters: defaultValueEmitters(),
  valueBindings: defaultValueBindings(),
};
...
export const controlSchema: ControlDef[] = [
  {
    ...
    max: 1,
    step: 0.01,
    help: "How fast each material ping-pongs between Color and Color B.",
  },
  {
    key: "contrast",
    label: "Contrast",
    ...
    max: 3,
    step: 0.05,
    help: "Display contrast of the shaded field.",
  },
  {
    key: "viewZoom",
    label: "View zoom",
    ...
    step: 0.01,
    reseed: true,
    help: "Crop of the field. Rebuilds the solver.",
  },
  {
    key: "dyeDecay",
    label: "Dye decay",
    ...
    max: 0.05,
    step: 0.001,
    help: "How quickly concentrations fade. 0 keeps pigment around.",
  },
  {
    key: "vorticity",
    label: "Vorticity",
    ...
    max: 40,
    step: 0.5,
    help: "Curl confinement. Higher values look more swirly.",
  },
  {
    key: "windStrength",
    label: "Wind",
    ...
    max: 80,
    step: 0.5,
    help: "Global multiplier on all wind stations.",
  },
  {
    key: "velocityDecay",
    ...
    max: 2,
    step: 0.01,
    help: "How fast motion dies. Higher is calmer.",
  },
  {
    key: "seedVelocityScale",
    label: "Seed velocity",
    group: "Flow",
    kind: "range",
    min: 0,
    ...
    step: 0.5,
    reseed: true,
    help: "Initial motion at reseed. Rebuilds the solver.",
  },
  {
    key: "splatForce",
    label: "Splat force",
    ...
    max: 8000,
    step: 50,
    help: "How hard pointer stir pushes the velocity field.",
  },
  {
    key: "composerStrength",
    label: "Strength",
    group: "Composer",
    kind: "range",
    min: 0,
    max: 80,
    step: 0.5,
    help: "Overall curl-noise drive when the composer is active.",
  },
  {
    key: "composerBroad",
    label: "Broad",
    ...
    max: 2,
    step: 0.01,
    help: "Large-scale curl-noise lobe.",
  },
  {
    key: "composerMedium",
    label: "Medium",
    ...
    max: 2,
    step: 0.01,
    help: "Mid-scale curl-noise lobe.",
  },
  {
    key: "composerFine",
    label: "Fine",
    ...
    max: 2,
    step: 0.01,
    help: "Small-scale curl-noise lobe.",
  },
  {
    key: "noiseType",
    label: "Noise",
    ...
    kind: "select",
    reseed: true,
    help: "Noise family for the composer. Rebuilds the solver.",
    options: [
  ...
  },
  {
    ...
    max: 8,
    step: 0.05,
    help: "Spatial frequency of composer noise.",
  },
  {
    key: "noiseTime",
    label: "Time speed",
    ...
    max: 1.2,
    step: 0.01,
    help: "How fast composer noise evolves.",
  },
  {
    key: "wiggleAmount",
    label: "Wiggle",
    ...
    max: 1,
    step: 0.01,
    help: "Slow Perlin modulation of noise scale and time.",
  },
  {
    key: "dyeInject",
    label: "Dye inject",
  ...
  },
  {
    ...
    step: 32,
    reseed: true,
    help: "Velocity grid size. Rebuilds the solver.",
  },
  {
    key: "dyeResolution",
    ...
    step: 32,
    reseed: true,
    help: "Concentration grid size. Must stay ≥ sim. Rebuilds the solver.",
  },
  {
    ...
    step: 1,
    reseed: true,
    help: "Jacobi steps per frame. Rebuilds the solver.",
  },
  {
    key: "warmupSteps",
    label: "Warmup steps",
    ...
    step: 1,
    reseed: true,
    help: "Hidden steps after reseed so the field is not empty. Rebuilds the solver.",
  },
  {
    key: "pointerEnabled",
    label: "Pointer stir",
